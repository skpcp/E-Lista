...
public class WebSecurityConfiguration  extends GlobalAuthenticationConfigurerAdapter {
        ...
        return new UserDetailsService(){
            ...
            public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException{
                ...
                if(uzytkownikOB!= null){
                    return new User(uzytkownikOB.getEmail(),uzytkownikOB.getHaslo(),true,true,true,true,getAuthorities(uzytkownikOB.getRola()));
    ...
    private List<String> getRoles(RolaOB role) {
    ...
    private Collection<? extends GrantedAuthority>getAuthorities(RolaOB role){
