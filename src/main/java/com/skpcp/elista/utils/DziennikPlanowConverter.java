...
public class DziennikPlanowConverter {
        ...
        public static DziennikPlanowDTO dziennikplanowOBdoDziennikPlanowowDTO(DziennikPlanowOB aDziennikPlanowOB){
            ...
            return new DziennikPlanowDTO(aDziennikPlanowOB.getIdUzytkownika(),aDziennikPlanowOB.getDzienTygodnia(),aDziennikPlanowOB.getPlanOd(),aDziennikPlanowOB.getPlanDo());
